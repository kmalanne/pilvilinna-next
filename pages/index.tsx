  ...
  return (
    <>
      ...
      <section aria-labelledby="title">
        ...
        <ServiceContainer>
          <ServiceTitle>{t('assortment_title')}</ServiceTitle>
          <Row>
            <Col sm={12} md={4}>
              <ServiceItem
                icon={faBirthdayCake}
                title={t('assortment_choice_1_title')}
                text={t('assortment_choice_1_description')}
              />
            </Col>
            <Col sm={12} md={4}>
              <ServiceItem
                icon={faBreadSlice}
                title={t('assortment_choice_2_title')}
                text={t('assortment_choice_2_description')}
              />
            </Col>
            <Col sm={12} md={4}>
              <ServiceItem
                icon={faCookie}
                title={t('assortment_choice_3_title')}
                text={t('assortment_choice_3_description')}
              />
            </Col>
          </Row>
        </ServiceContainer>
        <TestimonialContainer>
          <h2 className="sr-only">{t('testimonial_title')}</h2>
          <Row>
